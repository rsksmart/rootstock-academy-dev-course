...
contract OneMilNftPixels is ERC721, Ownable, IERC1363Receiver {
    ...
    ) ERC721("OneMilNftPixels", "NFT1MPX") Ownable(msg.sender) {
        require(
    ...
    function _transferReceived(
        ...
        (bytes4 selector, , uint24 pixelId, bytes3 colour, uint256 amount) = abi
            .decode(_data, (bytes4, address, uint24, bytes3, uint256));
