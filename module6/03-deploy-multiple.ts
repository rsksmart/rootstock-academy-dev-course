...
export async function main() {
  ...
  // I uncommented and filled in the SimpleToken deployment
  ...
  // I uncommented and filled in the PriceOracle deployment
  ...
  // I uncommented and filled in the NFTMarketplace deployment
  ...
  // I uncommented and added the setPriceOracle call
  ...
  // I added verification for payment token
  ...
  // I added verification for price oracle
