...
export async function main() {
  ...
  // Deploy PriceOracle (no constructor params)
  ...
  // Deploy NFTMarketplace passing SimpleToken address
  ...
  // Call setPriceOracle on marketplace
  ...
  // Verify marketplace.paymentToken() returns SimpleToken address
  ...
  // Verify marketplace.priceOracle() returns PriceOracle address
